        ...
        try {
            ...
            stmt.executeUpdate(
                    """
                            ...
                            (1, 'Anna Nowak', '90010112345', 'CAR', 150.00, '2024-01-15', TRUE),
                            (2, 'Jan Kowalski', '85050567890', 'HOME', 89.99, '2024-03-01', TRUE),
                            (3, 'Maria Wisniewska', '95121298765', 'TRAVEL', 45.00, '2024-06-10', FALSE),
                            (4, 'Piotr Zielinski', '78030334567', 'LIFE', 200.00, '2023-11-20', TRUE),
                            (5, 'Katarzyna Wojcik', '01082256789', 'CAR', 180.00, '2025-01-05', TRUE)
                            """
            );
